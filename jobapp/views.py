...
def submit_project(request):
    if request.method == 'POST':
        ...
        try:
            ...
            return JsonResponse({'success': False, 'error': 'Job does not exist'})
...
def job_list_View(request):
    ...
    return render(request, 'jobapp/project-list.html', context)
...
def create_job_View(request):
    ...
    return render(request, 'jobapp/post-project.html', context)
...
def single_job_view(request, id):
    ...
    return render(request, 'jobapp/project-single.html', context)
...
def job_edit_view(request, id=id):
    ...
    return render(request, 'jobapp/project-edit.html', context)
